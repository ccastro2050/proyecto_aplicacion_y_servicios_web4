...
> [README](../README.md)). SQL Server queda publicado en `localhost,11466`.
...
| Port | `11466` | El puerto del host del compose (`11466:1433`) |
...
> El puerto es la clave: **11466, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 11466
...
>
> ```
> Error opening connection Failed to connect to localhost:11466
...
> (`http://localhost:8035/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost,11466) con test y guardarla |
